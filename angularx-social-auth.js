...
var HashLocationStrategy = (function (_super) {
    __extends$124(HashLocationStrategy, _super);
    /**
...
var PathLocationStrategy = (function (_super) {
    __extends$124(PathLocationStrategy, _super);
    /**
     * @param {?} _platformLocation
     * @param {?=} href
     */
...
var NgLocaleLocalization = (function (_super) {
    __extends$124(NgLocaleLocalization, _super);
    /**
     * @param {?} locale
     */
...
function formatNumber(pipe, locale, value, style, digits, currency, currencyAsSymbol) {
    ...
    value = typeof value === 'string' && isNumeric$1(value) ? +value : value;
...
class FacebookLoginProvider extends BaseLoginProvider {
     ...
     * @param {?=} scope
     */
    constructor(clientId, scope = 'email,public_profile') {
        super();
        this.clientId = clientId;
        this.scope = scope;
    }
    ...
    initialize() {
        return new Promise((resolve, reject) => {
            this.loadScript(FacebookLoginProvider.PROVIDER_ID, "//connect.facebook.net/en_US/sdk.js", () => {
                FB.init({
                    appId: this.clientId,
...
export { AuthService, SocialLoginModule, SocialUser, GoogleLoginProvider, FacebookLoginProvider, AuthServiceConfig, BaseLoginProvider as ɵa };
